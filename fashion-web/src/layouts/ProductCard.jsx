...
const ProductCard = ({ id, img, name, price, discount }) => {
  return (
    <div
      className="h-[370px] 2xl:h-[420px] text-black rounded-xl shadow-[rgba(0,0,0,0.24)_0px_3px_8px] mb-2 cursor-pointer"
      key={id}
    >
      <div className="product-image-wrapper">
        <img
          src={img}
          alt="img"
          className="product-img h-56 2xl:h-64 rounded-t-xl w-full object-cover"
        />
      </div>
